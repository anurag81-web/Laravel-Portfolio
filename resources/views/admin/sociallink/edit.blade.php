...
<div class="container mx-auto py-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-8 text-center">Edit Social Link</h1>
    ...
    <form action="{{ route('admin.sociallink.update', $socialLink) }}" method="POST"
        ...
        <div class="mb-6">
            ...
            <input type="text" name="platform" value="{{ old('platform', $socialLink->platform) }}"
