...
<div class="container mx-auto py-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-8 text-center">Add Social Link</h1>
    ...
    <form action="{{ route('admin.sociallink.store') }}" method="POST"
        class="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
        @csrf

        <div class="mb-6">
            <label class="block mb-2 font-bold text-gray-700">Platform Name</label>
        ...
        <div class="mb-6">
            <label class="block mb-2 font-bold text-gray-700">URL</label>
        ...
        <div class="flex items-center gap-4 mt-8 pt-6 border-t border-gray-100">
            ...
            <a href="{{ route('admin.sociallink.index') }}"
                class="px-6 py-3 bg-white border-2 border-indigo-100 text-indigo-600 hover:bg-indigo-50 font-medium rounded-xl transition-all ml-auto">Back
            </a>
        </div>
    </form>
</div>
