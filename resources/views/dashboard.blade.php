        ...
        <div id="sidebar" class="sidebar" 
            ...
            <ul style="list-style: none; padding: 0;">
                <li style="margin-bottom: 1rem;">
                    <a href="{{ route('admin.intro') }}" style="display: block; color: rgba(255,255,255,0.9); text-decoration: none; transition: color 0.3s;">Intro</a>
                </li>
                <li style="margin-bottom: 1rem;">
                    <a href="{{ route('admin.about') }}" style="display: block; color: rgba(255,255,255,0.9); text-decoration: none; transition: color 0.3s;">About Me</a>
                </li>
                <li style="margin-bottom: 1rem;">
                    <a href="{{ route('admin.skills') }}" style="display: block; color: rgba(255,255,255,0.9); text-decoration: none; transition: color 0.3s;">Skills</a>
                </li>
                <li style="margin-bottom: 1rem;">
                    <a href="{{ route('admin.projects') }}" style="display: block; color: rgba(255,255,255,0.9); text-decoration: none; transition: color 0.3s;">Projects</a>
                </li>
